...
> 최종 업데이트: 2026-04-03 (PM — Task 27 스펙 검증, Task 28 계획)
> QA 단계: Phase 3 진행 중 — P3-0/P3-1/P3-2/P3-3/P3-4/P3-5 완료, P3-6 (구매자 데이터 삭제권) 진행 중 (Task 27), B-28/B-29 클린업 (Task 28 예정)
...
| B-12 | 택배사 API 배송 추적 없음 | ✅ **완료** (Task 25, fbadce1) |
...
| 배송 추적 링크 (택배사별 URL) | 기획서 명시 | ✅ 완료 (2026-04-03, Task 25) |
| 셀러 이메일 인증 | 기획서 명시 | ✅ 완료 (Task 26) |
| 구매자 데이터 삭제권 (GDPR) | 개인정보법 요구 | 🔄 Task 27 진행 중 |
