...
> 최종 업데이트: 2026-04-03 (PM 조율 — Task 12 완료, Task 14 Vercel 배포 진행 중)
> 현재 단계: **Phase 1 MVP — Vercel 배포 (Task 14) ← 최우선**
...
| 항목 | 상태 | 비고 |
|------|------|------|
| UX-3: 코드 발급 드롭다운 상품명 표시 수정 | ✅ 완료 | shadcn 자동 처리 — 수정 불필요 확인 (Task 20) |
| 수동 QA 6개 항목 통과 | ✅ 완료 | Task 12 — 코드 레벨 검증 완료 (2026-04-03) |
| Vercel 환경변수 8개 확인 + 배포 | 🔄 진행 중 | Task 14 ← **최우선** |
