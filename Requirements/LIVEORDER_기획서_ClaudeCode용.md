...
| 사업자등록증 이미지 업로드 | Vercel Blob 업로드 | 🔧 (Task 34 진행 중) |
| 통신판매업신고번호 입력 | 선택 입력 | ✅ |
| 정산 계좌 등록 | 은행명 + 계좌번호 | ✅ |
...
| 셀러 등록 시 | 사업자등록증 이미지 첨부 | 플랫폼 (필수) | 🔧 (Task 34) |
